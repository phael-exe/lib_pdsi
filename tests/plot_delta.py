...
def plot_delta():
    """
    Gera o plot do sinal impulso unitário (delta de Kronecker).
    δ[n] = 1 se n = 0, caso contrário 0
    """
    # Define o range de n
    n = np.arange(-10, 11)
    ...
    ax.set_ylabel('δ[n]', fontsize=12, color='lime')
    ax.set_title('1. The unit impulse (Kronecker delta)\nδ[n] = 1 if n = 0, else 0', 
